...
void read_stat(FILE *output, const char *pid)
{
    ...
    fprintf(output, "44. Start_data: %lx\n", start_data);
    fprintf(output, "45. End_data: %lx\n", end_data);
    fprintf(output, "46. Start_brk: %lx\n", start_brk);
    fprintf(output, "47. Arg_start: %lx\n", arg_start);
    fprintf(output, "48. Arg_end: %lx\n", arg_end);
    fprintf(output, "49. Env_start: %lx\n", env_start);
    fprintf(output, "50. Env_end: %lx\n", env_end);
